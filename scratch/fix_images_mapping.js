...
const targetStr = `        const allProducts = [...faceprintProducts, ...featuredProducts].map(p => ({
            ...p,
...
const replacementStr = `        const imgMap = {
...
if (content.includes(targetStr)) {
    ...
    console.log("Successfully fixed product images mapping in functions/index.js");
} else {
    console.log("Could not find the target allProducts mapping string!");
}
